...
case $site in
  staging)
    ...
    NEXT_PUBLIC_CONTRACT_IDS_TESTNET='["00000000361ec0406d90a5bb4c6c7330af5792178b86cfc353afd4e50a62b741", "00000000b275d12824faa41177c7087fbc516b6d1811f780291036056d2cf1b3"]'
  ...
  production)
    ...
    NEXT_PUBLIC_CONTRACT_IDS_MAINNET='["0000000079862340c1f7822b81f58668e2a62c5f1b69d8d2e3b8fdf1855196c1"]'
    NEXT_PUBLIC_USE_MOCK_WALLET=false
    NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID=8264fff563181da658ce64ee80e80458
...
case $command in
  build)
    ...
    echo "NEXT_PUBLIC_CONTRACT_IDS_TESTNET: $NEXT_PUBLIC_CONTRACT_IDS_TESTNET"
    echo "NEXT_PUBLIC_CONTRACT_IDS_MAINNET: $NEXT_PUBLIC_CONTRACT_IDS_MAINNET"
